import { EVENT_DATE_LABEL, EVENT_NAME, ORGANISATION_NAME, TICKET_TYPE_LABELS, } from '@pravasi/shared';
/**
 * The delivery email.
 *
...
const GOLD = '#d4af37';
const MAROON = '#800000';
export function ticketEmailSubject(data) {
    return `Your ${EVENT_NAME} e-ticket — ${data.ticketNumber}`;
}
export function ticketEmailText(data) {
    return [
        `${data.purchaserName},`,
        '',
...
export function ticketEmailHtml(data) {
    const rows = [
        ['Ticket Number', data.ticketNumber],
        ['Request Number', data.requestNumber],
...
//# sourceMappingURL=tickets.email.js.map